...
const Header = () => {
  ...
  return (
    <>
      ...
      <motion.div className="bg-gradient-to-r from-blue-900 to-blue-700 text-white text-sm">
        <div className="container mx-auto px-4 py-3 flex flex-wrap justify-between items-center">
          <div className="flex items-center space-x-6">
            ...
            >
              ...
              <a href="tel:9555699988">+91 9555699988,</a>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="flex items-center"
            >
              ...
              <a href="mailto:admission.cell@seglko.org">admission.cell@seglko.org</a>
            </motion.div>
          </div>
        </div>
      </motion.div>
      ...
      <motion.header className="bg-white/90 backdrop-blur-md shadow-sm sticky top-0 z-40 border-b border-gray-100">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-3">
            ...
            <Link to="/" className="flex items-center group">
              ...
              >
                <motion.img src={logo} alt="College Logo" className="h-16" />
                <motion.div
                      ...
                      >
                        ...
                        <motion.span
                          animate={{
                            ...
                            color:
                              hoveredItem === index ? "#1d4ed8" : "#1f2937",
                          }}
                          transition={{ duration: 0.2 }}
                          className="ml-1"
                        >
